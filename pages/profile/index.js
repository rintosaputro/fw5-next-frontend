          ...
          <section className="col-12 col-lg-8">
            <div className="card px-4 py-5 bg-light">
              <div className={`${styles.pict} mx-auto`} style={{ backgroundImage: `url(${picture || defaultPict})` }} id="picture">
                <form>
                  <input
                    id="image"
                    style={{
                      zIndex: 134, right: '134px', opacity: '0', cursor: 'pointer',
                    }}
              ...
              <div className="position-relative">
                <button className="btn d-flex justify-content-center text-white align-items-center mx-auto mt-3" type="button">
