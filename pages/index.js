      ...
      <Layout fullFooter>
        <main className="mt-5">
          <header className="container">
            <div className="row align-items-center">
              <div className={`${styles.left} col-12 col-lg-6`}>
                <h1 className={`${styles.headText} fs-1`}>
                  Awesome App
                  {' '}
                  <br />
                  {' '}
              ...
              <Col sm={12} lg={7} className="ps-3 mt-sm-5 mt-lg-0">
                <Row>
                  {[...Array(6)].map((item, index) => (
                    <Col xs={6} md={4} key={index} className="m-auto text-center">
            ...
            <div className="container">
              <Row>
                ...
                <Col sm={12} lg={7} className="mt-5">
                  <h1 className={`${styles.headText} fs-1 mt-4`}>
                    All The
                    {' '}
          ...
          <section className="container py-5 mb-5">
            <h1 className={`${styles.headText} fs-1 mt-4 text-center`}>
              What Users are
              {' '}
            ...
            <Row>
              {dataReview.map((item) => (
                <CardLanding
                  ...
                  image={(
                    <div>
                      <div className={`review-photo ${styles.photoRev}`} style={{ backgroundImage: `url(${item.img})` }} />
                    </div>
                )}
                  head={item.name}
                  par={item.par}
